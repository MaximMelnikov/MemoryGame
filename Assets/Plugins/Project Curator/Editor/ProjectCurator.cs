...
namespace Ogxd.ProjectCurator
{
    ...
    {
        [NonSerialized]
        public static Dictionary<string, AssetInfo> pathToAssetInfo;
        ...
        public static void RebuildDatabase()
        {
            ...
            //List<string> allAssetPaths2 = new List<string>();

            /*foreach (var item in allAssetPaths)
            {
                if (!item.StartsWith("Assets/AddressableAssetsData/"))
                {
                    allAssetPaths2.Add(item);
                }
            }*/

            //allAssetPaths = allAssetPaths2.ToArray();
